...
document.getElementById("buttonNoMoreGame").onclick = gameInit
...
// hold valide le score provisoire effectué et l'ajoute au score global et ensuite passe le tour au joueur suivant

function hold() {
    if (playerNumberStart === 1) {
        globalPlayer1 = globalPlayer1 + roundPlayer1
        document.getElementById("globalPlayer1").textContent = globalPlayer1
        if (globalPlayer1 >= maxScore) {
...
// lance la function gameInit au demarrage 
gameInit()
